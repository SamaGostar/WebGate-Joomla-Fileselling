 ...
 * @subpackage Models
 */
class joominaFSModelCategory extends JModel
{
    /**
     * Category id
     *
    ...
    public function __construct()
    {
        ...
        $this->setState('limit', $app->getUserStateFromRequest('com_joominafs.limit'
    ...
    /**
     * Method to get a pagination object of the joominaFS items for the category
     *
